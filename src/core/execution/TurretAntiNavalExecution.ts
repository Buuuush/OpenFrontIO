...
/**
 * TurretAntiNavalExecution: Ground-to-sea defensive turret.
 * Targets naval enemy units (ships) within range and shoots shells.
 */
export class TurretAntiNavalExecution implements Execution {
  ...
  tick(ticks: number): void {
    ...
    // Target nearby naval enemy units
